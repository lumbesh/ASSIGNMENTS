...
$stringTwo = 'vinz.ag15@gmail.com';

$peopleOne = ['Vince', 'Vinz', 'Beans'];
$peopleTwo = array('yawaman', 'eyeyron');
$ages = [20, 25, 18, 19];

$blogs = [
	['Ano meron', 'Wala ba diyan', 'lorem', 25],
	['Debut man', 'set', 'lorem', 18],
	['Golden Chest', 'link', 'lorem', 19]
];
